...
new _menu.Menu(document.querySelector('.menu'));
// Preloading webkit font
_utils.preloadFonts('zhn4ifz').then(()=>document.body.classList.remove('loading')
);

},{"./utils":"72Dku","./menu":"dTgwB"}],"72Dku":[function(require,module,exports) {
...
class Menu {
     ...
     */ constructor(DOM_el){
        ...
        this.DOM.items.forEach((item)=>this.menuItems.push(new _menuItem.MenuItem(item))
        );
        this.initEvents();
    }
    /**
     ...
     */ initEvents() {
        this.DOM.menuCtrl.el.addEventListener('click', ()=>{
            ...
            if (!this.menuStatus.isOpen) this.open();
            else this.close();
        });
    }
    /**
     ...
     */ open() {
        ...
        this.menuTimeline = _gsap.gsap.timeline({
            defaults: {
                duration: 1.7,
                ease: 'expo.inOut'
            },
            ...
            ease: 'power2.inOut',
            opacity: 0
        }, 'start').to(this.menuItems.map((item)=>item.DOM.slotMachine
        ), {
            //ease: 'power3.inOut',
            y: `${100 / _menuConfig.menuConfig.slotMachineTotalLetters * (_menuConfig.menuConfig.slotMachineTotalLetters - 1)}%`,
            stagger: 0.03
        }, 'start');
...
},{"gsap":"fPSuC","splitting/dist/splitting.css":"3uR7n","splitting/dist/splitting-cells.css":"7jeGL","splitting":"77jB6","./menuConfig":"6VwYQ","./menuItem":"gkdt8","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"fPSuC":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{}],"6VwYQ":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "menuConfig", ()=>menuConfig
);
let menuConfig = {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"gkdt8":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
/**
...
class MenuItem {
     ...
     */ constructor(DOM_el){
        ...
        this.DOM.chars = [
            ...this.DOM.el.querySelectorAll('span.char')
        ];
        this.itemPosition = [
            ...this.DOM.el.parentNode.children
        ].indexOf(this.DOM.el);
     ...
     */ layout() {
        ...
        const totalRandomChars = _menuConfig.menuConfig.slotMachineTotalLetters - 2;
        ...
        this.DOM.chars.forEach((char, charPosition)=>{
            ...
            if (charPosition === 0) {
                ...
                }, (_)=>allChars.charAt(Math.floor(Math.random() * allChars.length))
                );
                let htmlStr = `<span>${char.innerHTML}</span>`;
                for(let i = 0; i <= totalRandomChars - 1; ++i)htmlStr += i === totalRandomChars - 1 ? `<span>${randomCharsArray[i]}</span><span>${_menuConfig.menuConfig.displayVerticalTitle.charAt(this.itemPosition)}</span>` : `<span>${randomCharsArray[i]}</span>`;
...
},{"./menuConfig":"6VwYQ","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["kn9T2","ljsGX","ebWYT"], "ebWYT", "parcelRequire22c5")
